...
{
	CHECK_ERROR(_readLookupSource_V24(c, &m->dest));
...
{
    CHECK_ERROR(_readKeys_V24(c, &m->keys))
...
{
    CHECK_ERROR(_readLookupSource_V24(c, &m->controller))
    CHECK_ERROR(_readCompactBalanceOf(c, &m->value))
    CHECK_ERROR(_readRewardDestination_V24(c, &m->payee))
    return parser_ok;
}
...
{
    CHECK_ERROR(_readValidatorPrefs_V24(c, &m->prefs))
    return parser_ok;
}
...
{
    CHECK_ERROR(_readVecLookupSource_V24(c, &m->targets))
    return parser_ok;
}
...
{
    CHECK_ERROR(_readAccountId_V24(c, &m->validator_stash))
    CHECK_ERROR(_readEraIndex_V24(c, &m->era))
    return parser_ok;
}
...
__Z_INLINE parser_error_t _readMethod_assets_transfer_V24(
    parser_context_t* c, pd_assets_transfer_V24_t* m)
{
	CHECK_ERROR(_readAssetId_V24(c, &m->asset_id));
	CHECK_ERROR(_readAccountId_V24(c, &m->to));
	CHECK_ERROR(_readAmount_V24(c, &m->amount));
	return parser_ok;
}
 ...
 * PoolXYK idx: 25
 */
__Z_INLINE parser_error_t _readMethod_poolXYK_deposit_Liquidity_V24(
    parser_context_t* c, pd_poolxyk_deposit_liquidity_V24_t* m)
{
	CHECK_ERROR(_readDexId_V24(c, &m->dex_id))
	CHECK_ERROR(_readAssetId_V24(c, &m->input_asset_a))
	CHECK_ERROR(_readAssetId_V24(c, &m->input_asset_b))
	CHECK_ERROR(_readBalance_V24(c, &m->input_a_desired))
	CHECK_ERROR(_readBalance_V24(c, &m->input_b_desired))
	CHECK_ERROR(_readBalance_V24(c, &m->input_a_min))
	CHECK_ERROR(_readBalance_V24(c, &m->input_b_min))
	return parser_ok;
}
__Z_INLINE parser_error_t _readMethod_poolXYK_withdraw_Liquidity_V24(
    parser_context_t* c, pd_poolxyk_withdraw_liquidity_V24_t* m)
{
	CHECK_ERROR(_readDexId_V24(c, &m->dex_id))
	CHECK_ERROR(_readAssetId_V24(c, &m->output_asset_a))
	CHECK_ERROR(_readAssetId_V24(c, &m->output_asset_b))
	CHECK_ERROR(_readBalance_V24(c, &m->marker_asset_desired))
	CHECK_ERROR(_readBalance_V24(c, &m->output_a_min))
	CHECK_ERROR(_readBalance_V24(c, &m->output_b_min))
	return parser_ok;
}
/*
 * LiquidityProxy idx:26
 */
__Z_INLINE parser_error_t _readMethod_liquidityproxy_swap_V24(
    parser_context_t* c, pd_liquidityproxy_swap_V24_t* m)
{
	CHECK_ERROR(_readDexId_V24(c, &m->dex_id));
	CHECK_ERROR(_readAssetId_V24(c, &m->input_asset_id));
	CHECK_ERROR(_readAssetId_V24(c, &m->output_asset_id));
	CHECK_ERROR(_readOptionSwapAmount_V24(c, &m->swap_amount));
	CHECK_ERROR(_readVecLiquiditySourceType_V24(c, &m->selected_source_types));
	CHECK_ERROR(_readFilterMode_V24(c, &m->filter_mode));
 ...
 * EthBridge idx: 31
 */
__Z_INLINE parser_error_t _readMethod_ethbridge_transfer_to_sidechain_V24(
    parser_context_t* c, pd_ethbridge_transfer_to_sidechain_V24_t* m)
{
	CHECK_ERROR(_readAssetIdOf_V24(c, &m->asset_id));
	CHECK_ERROR(_readEthereumAddress_V24(c, &m->to));
	CHECK_ERROR(_readBalance_V24(c, &m->amount));
	CHECK_ERROR(_readBridgeNetworkId_V24(c, &m->network_id));
	return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_ethbridge_request_from_sidechain_V24(
    parser_context_t* c, pd_ethbridge_request_from_sidechain_V24_t* m)
{
	CHECK_ERROR(_readHash(c, &m->eth_tx_hash));
	CHECK_ERROR(_readIncomingRequestKind_V24(c, &m->kind));
	CHECK_ERROR(_readBridgeNetworkId_V24(c, &m->network_id));
	return parser_ok;
}
 ...
 */
__Z_INLINE parser_error_t _readMethod_PswapDistribution_claim_incentive_V24(
    parser_context_t* c, pd_pswapdistribution_claim_incentive_V24_t* m)
{
	return parser_ok;
}
 ...
 */
__Z_INLINE parser_error_t _readMethod_VestedRewards_claim_rewards_V24(
    parser_context_t* c, pd_vestedrewards_claim_rewards_V24_t* m)
{
	return parser_ok;
}
 ...
 * CeresStaking idx: 45
 */
__Z_INLINE parser_error_t _readMethod_CeresStaking_deposit_V24(
    parser_context_t* c, pd_ceresstaking_deposit_V24_t* m)
{
	CHECK_ERROR(_readBalance_V24(c, &m->amount));
	return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_CeresStaking_withdraw_V24(
    parser_context_t* c, pd_ceresstaking_withdraw_V24_t* m)
{
	return parser_ok;
}
    ...
    pd_Method_V24_t* method)
{
    ...
    switch (callPrivIdx) {
		...
		case 2818:
			CHECK_ERROR(_readMethod_utility_batch_all_V24(c, &method->nested.utility_batch_all_V24))
			break;
		/* module 17 call 0 - Staking.bond */
		case 4352:
			CHECK_ERROR(_readMethod_staking_bond_V24(c, &method->basic.staking_bond_V24))
			break;
		/* module 17 call 1 */
		case 4353:
			CHECK_ERROR(_readMethod_staking_bond_extra_V24(c, &method->basic.staking_bond_extra_V24))
			break;
		/* module 17 call 2 */
		case 4354:
			CHECK_ERROR(_readMethod_staking_unbond_V24(c, &method->basic.staking_unbond_V24))
			break;
		/* module 17 call 3 */
		case 4355:
			CHECK_ERROR(_readMethod_staking_withdraw_unbonded_V24(c, &method->basic.staking_withdraw_unbonded_V24))
			break;
		/* module 17 call 4 */
		case 4356:
		...
		/* module 17 call 5 */
		case 4357:
			CHECK_ERROR(_readMethod_staking_nominate_V24(c, &method->basic.staking_nominate_V24))
			break;
		/* module 17 call 6 */
		case 4358:
			CHECK_ERROR(_readMethod_staking_chill_V24(c, &method->basic.staking_chill_V24))
			break;
		/* module 17 call 7 */
		case 4359:
			CHECK_ERROR(_readMethod_staking_set_payee_V24(c, &method->basic.staking_set_payee_V24))
			break;
		/* module 17 call 8 */
		case 4360:
			CHECK_ERROR(_readMethod_staking_set_controller_V24(c, &method->basic.staking_set_controller_V24))
			break;
		/* module 17 call 18 */
		case 4370:
		...
		/* module 17 call 19 */
		case 4371:
			CHECK_ERROR(_readMethod_staking_rebond_V24(c, &method->basic.staking_rebond_V24))
			break;
		/* module 21 call 1 - Assets.transfer */
		case 5377:
			CHECK_ERROR(_readMethod_assets_transfer_V24(c, &method->basic.assets_transfer_V24))
			break;
		/* module 25 call 0 - PoolXYK.DepositLiquidity */
		case 6400:
			CHECK_ERROR(_readMethod_poolXYK_deposit_Liquidity_V24(c, &method->basic.poolxyk_deposit_liquidity_V24))
			break;
		/* module 25 call 1 - PoolXYK.WithdrawLiquidity */
		case 6401:
			CHECK_ERROR(_readMethod_poolXYK_withdraw_Liquidity_V24(c, &method->basic.poolxyk_withdraw_liquidity_V24))
			break;
		/* module 26 call 0 - LiquidityProxy.swap */
		case 6656:
			CHECK_ERROR(_readMethod_liquidityproxy_swap_V24(c, &method->basic.liquidityproxy_swap_V24))
			break;
		/* module 31 - 3 - ethBridge.transfer_to_sidechain */
		case 7939:
			CHECK_ERROR(_readMethod_ethbridge_transfer_to_sidechain_V24(c, &method->basic.ethbridge_transfer_to_sidechain_V24))
			break;
		/* module 31 - 4 - ethBridge.request_from_sidechain */
		case 7940:
			CHECK_ERROR(_readMethod_ethbridge_request_from_sidechain_V24(c, &method->basic.ethbridge_request_from_sidechain_V24))
			break;
		/* module 32 - 0 - PswapDistribution.claim_incentive */
		case 8192:
			CHECK_ERROR(_readMethod_PswapDistribution_claim_incentive_V24(c, &method->basic.pswapdistribution_claim_incentive_V24))
			break;
		/* module 40 - 0 - VestedRewards.claim_rewards */
		case 10240:
			CHECK_ERROR(_readMethod_VestedRewards_claim_rewards_V24(c, &method->basic.vestedrewards_claim_rewards_V24))
			break;
		/* module 45 - 0 - ceresstaking.deposit */
		case 11520:
			 CHECK_ERROR(_readMethod_CeresStaking_deposit_V24(c, &method->basic.ceresstaking_deposit_V24));
			 break;
		/* module 45 - 1 - ceresstaking.withdraw */
		case 11521:
			 CHECK_ERROR(_readMethod_CeresStaking_withdraw_V24(c, &method->basic.ceresstaking_withdraw_V24));
			 break;
#ifdef SUBSTRATE_PARSER_FULL
    ...
    uint8_t pageIdx, uint8_t* pageCount)
{
	...
	case 515: /* module 3 call 3 - Balances.transfer_keep_alive */
        ...
        case 0: /* balances_transfer_keep_alive_V24 - dest */;
            return _toStringLookupSource_V24(
                ...
                outValue, outValueLen,
                pageIdx, pageCount);
        case 1: /* balances_transfer_keep_alive_V24 - value */;
            return _toStringCompactBalance(
                &m->nested.balances_transfer_keep_alive_V24.value,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
	...
	case 4352:
		switch (itemIdx) {
			case 0: /* staking_bond_V24 - controller */;
				return _toStringLookupSource_V24(
					&m->basic.staking_bond_V24.controller,
					outValue, outValueLen,
					pageIdx, pageCount);
			case 1: /* staking_bond_V24 - value */;
				return _toStringCompactBalanceOf(
					&m->basic.staking_bond_V24.value,
					outValue, outValueLen,
					pageIdx, pageCount);
			case 2: /* staking_bond_V24 - payee */;
				return _toStringRewardDestination_V24(
					&m->basic.staking_bond_V24.payee,
					outValue, outValueLen,
					pageIdx, pageCount);
			default:
				return parser_no_data;
	...
	case 4353: /* module 7 call 1 */
			switch (itemIdx) {
			case 0: /* staking_bond_extra_V24 - max_additional */;
				return _toStringCompactBalanceOf(
					&m->basic.staking_bond_extra_V24.max_additional,
					outValue, outValueLen,
					pageIdx, pageCount);
			default:
				return parser_no_data;
	...
	case 4354: /* module 7 call 2 */
		switch (itemIdx) {
		case 0: /* staking_unbond_V24 - value */;
			return _toStringCompactBalanceOf(
				&m->basic.staking_unbond_V24.value,
				outValue, outValueLen,
				pageIdx, pageCount);
		default:
			return parser_no_data;
	...
	case 4355: /* module 7 call 3 */
		...
		case 0: /* staking_withdraw_unbonded_V24 - num_slashing_spans */;
			return _toStringu32(
				&m->basic.staking_withdraw_unbonded_V24.num_slashing_spans,
				outValue, outValueLen,
				pageIdx, pageCount);
		default:
			return parser_no_data;
	...
	case 4356: /* module 7 call 4 */
		...
		case 0: /* staking_validate_V24 - prefs */;
			return _toStringValidatorPrefs_V24(
	...
	case 4357: /* module 7 call 5 */
		...
		case 0: /* staking_nominate_V24 - targets */;
			return _toStringVecLookupSource_V24(
				&m->basic.staking_nominate_V24.targets,
				outValue, outValueLen,
				pageIdx, pageCount);
		default:
			return parser_no_data;
	...
	case 4359: /* module 7 call 7 */
		...
		case 0: /* staking_set_payee_V24 - payee */;
			return _toStringRewardDestination_V24(
				&m->basic.staking_set_payee_V24.payee,
				outValue, outValueLen,
				pageIdx, pageCount);
		default:
			return parser_no_data;
	...
	case 4360: /* module 7 call 8 */
		switch (itemIdx) {
		case 0: /* staking_set_controller_V24 - controller */;
			return _toStringLookupSource_V24(
				&m->basic.staking_set_controller_V24.controller,
				outValue, outValueLen,
				pageIdx, pageCount);
		default:
			return parser_no_data;
	...
	case 4371: /* module 7 call 19 */
		switch (itemIdx) {
			case 0: /* staking_rebond_V24 - value */;
				return _toStringCompactBalanceOf(
					&m->basic.staking_rebond_V24.value,
					outValue, outValueLen,
					pageIdx, pageCount);
			default:
				return parser_no_data;
    ...
    case 5377:
        switch (itemIdx) {
			case 0: // assets_transfer_V24 - asset_id
				return _toStringAssetId_V24(
					&m->basic.assets_transfer_V24.asset_id,
					outValue, outValueLen,
					pageIdx, pageCount);
			case 1: // assets_transfer_V24 - to
				return _toStringAccountId_V24(
					&m->basic.assets_transfer_V24.to,
					outValue, outValueLen,
				   pageIdx, pageCount);
			case 2: // assets_transfer_V24 - amount
				return _toStringBalance_V24(
					&m->basic.assets_transfer_V24.amount,
					outValue, outValueLen,
					pageIdx, pageCount);
			default:
				return parser_no_data;
	...
	case 6400:
		switch (itemIdx) {
			case 0: // PoolXYK.DepositLiquidity - dex_id
				return _toStringDexId_V24(
					&m->basic.poolxyk_deposit_liquidity_V24.dex_id,
					outValue, outValueLen,
					pageIdx, pageCount);
			case 1: // PoolXYK.DepositLiquidity - input_asset_a
				return _toStringAssetId_V24(
					&m->basic.poolxyk_deposit_liquidity_V24.input_asset_a,
					outValue, outValueLen,
					pageIdx, pageCount);
			case 2: // PoolXYK.DepositLiquidity - input_asset_b
				return _toStringAssetId_V24(
					&m->basic.poolxyk_deposit_liquidity_V24.input_asset_b,
					outValue, outValueLen,
					pageIdx, pageCount);
			case 3: // PoolXYK.DepositLiquidity - input_a_desired
				return _toStringBalance_V24(
					&m->basic.poolxyk_deposit_liquidity_V24.input_a_desired,
					outValue, outValueLen,
					pageIdx, pageCount);
			case 4: // PoolXYK.DepositLiquidity - input_b_desired
				return _toStringBalance_V24(
					&m->basic.poolxyk_deposit_liquidity_V24.input_b_desired,
					outValue, outValueLen,
					pageIdx, pageCount);
			case 5: // PoolXYK.DepositLiquidity - input_a_min
				return _toStringBalance_V24(
					&m->basic.poolxyk_deposit_liquidity_V24.input_a_min,
					outValue, outValueLen,
					pageIdx, pageCount);
			case 6: // PoolXYK.DepositLiquidity - input_b_min
				return _toStringBalance_V24(
					&m->basic.poolxyk_deposit_liquidity_V24.input_b_min,
					outValue, outValueLen,
					pageIdx, pageCount);
			default:
				return parser_no_data;
	...
	case 6401:
		switch (itemIdx) {
			case 0: // PoolXYK.WithdrawLiquidity - dex_id
				return _toStringDexId_V24(
					&m->basic.poolxyk_withdraw_liquidity_V24.dex_id,
					outValue, outValueLen,
					pageIdx, pageCount);
			case 1: // PoolXYK.WithdrawLiquidity - output_asset_a
				return _toStringAssetId_V24(
					&m->basic.poolxyk_withdraw_liquidity_V24.output_asset_a,
					outValue, outValueLen,
					pageIdx, pageCount);
			case 2: // PoolXYK.WithdrawLiquidity - output_asset_b
				return _toStringAssetId_V24(
					&m->basic.poolxyk_withdraw_liquidity_V24.output_asset_b,
					outValue, outValueLen,
					pageIdx, pageCount);
			case 3: // PoolXYK.WithdrawLiquidity - marker_asset_desired
				return _toStringBalance_V24(
					&m->basic.poolxyk_withdraw_liquidity_V24.marker_asset_desired,
					outValue, outValueLen,
					pageIdx, pageCount);
			case 4: // PoolXYK.WithdrawLiquidity - output_a_min
				return _toStringBalance_V24(
					&m->basic.poolxyk_withdraw_liquidity_V24.output_a_min,
					outValue, outValueLen,
					pageIdx, pageCount);
			case 5: // PoolXYK.WithdrawLiquidity - output_b_min
				return _toStringBalance_V24(
					&m->basic.poolxyk_withdraw_liquidity_V24.output_b_min,
					outValue, outValueLen,
					pageIdx, pageCount);
			default:
				return parser_no_data;
	...
	case 6656:
		switch (itemIdx) {
			case 0: // LiquidityProxy_swap - dex_id
				return _toStringDexId_V24(
					&m->basic.liquidityproxy_swap_V24.dex_id,
					outValue, outValueLen,
					pageIdx, pageCount);
			case 1: // LiquidityProxy_swap - input_asset_id
				return  _toStringAssetId_V24(
					&m->basic.liquidityproxy_swap_V24.input_asset_id,
					outValue, outValueLen,
					pageIdx, pageCount);
			case 2: // LiquidityProxy_swap - swap_amount_out
				return _toStringOptionSwapAmount_Out_V24(
					&m->basic.liquidityproxy_swap_V24.swap_amount,
					outValue, outValueLen,
					pageIdx, pageCount);
			case 3: // LiquidityProxy_swap - output_asset_id
				return _toStringAssetId_V24(
					&m->basic.liquidityproxy_swap_V24.output_asset_id,
					outValue, outValueLen,
					pageIdx, pageCount);
			case 4: // LiquidityProxy_swap - swap_amount_in
				return _toStringOptionSwapAmount_In_V24(
					&m->basic.liquidityproxy_swap_V24.swap_amount,
					outValue, outValueLen,
					pageIdx, pageCount);
			case 5: // LiquidityProxy_swap - selected_source_types
				return _toStringVecLiquiditySourceType_V24(
					&m->basic.liquidityproxy_swap_V24.selected_source_types,
					outValue, outValueLen,
					pageIdx, pageCount);
			case 6: // LiquidityProxy_swap - filter_mode
				//return parser_here_7;
				return _toStringu8(
					&m->basic.liquidityproxy_swap_V24.filter_mode,
					outValue, outValueLen,
					pageIdx, pageCount);
			default:
				return parser_no_data;
	...
	case 7939:
		switch (itemIdx) {
			case 0:
				return _toStringAssetId_V24(
					&m->basic.ethbridge_transfer_to_sidechain_V24.asset_id,
					outValue, outValueLen,
					pageIdx, pageCount);
			case 1:
				return _toStringEthereumAddress_V24(
					&m->basic.ethbridge_transfer_to_sidechain_V24.to,
					outValue, outValueLen,
					pageIdx, pageCount);
			case 2:
				return _toStringBalance_V24(
					&m->basic.ethbridge_transfer_to_sidechain_V24.amount,
					outValue, outValueLen,
					pageIdx, pageCount);
			case 3:
				return _toStringBridgeNetworkId_V24(
					&m->basic.ethbridge_transfer_to_sidechain_V24.network_id,
					outValue, outValueLen,
					pageIdx, pageCount);
			default:
				return parser_no_data;
		...
		switch (itemIdx) {
			case 0:
				return _toStringHash(
					&m->basic.ethbridge_request_from_sidechain_V24.eth_tx_hash,
					outValue, outValueLen,
					pageIdx, pageCount);
			case 1:
				return _toStringEthereumAddress_V24(
					&m->basic.ethbridge_request_from_sidechain_V24.kind,
					outValue, outValueLen,
					pageIdx, pageCount);
			case 2:
				return _toStringBridgeNetworkId_V24(
					&m->basic.ethbridge_request_from_sidechain_V24.network_id,
					outValue, outValueLen,
					pageIdx, pageCount);
			default:
				return parser_no_data;
	...
	case 11520:
		switch (itemIdx) {
			case 0:
				return _toStringBalance_V24(
					&m->basic.ceresstaking_deposit_V24.amount,
					outValue, outValueLen,
					pageIdx, pageCount);;
			default:
				return parser_no_data;
