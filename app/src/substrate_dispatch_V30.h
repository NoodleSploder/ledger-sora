...
#include "substrate_functions_V30.h"
#include <stddef.h>
#include <stdint.h>


parser_error_t _readMethod_V30(parser_context_t* c, uint8_t moduleIdx, uint8_t callIdx, pd_Method_V30_t* method);
...
parser_error_t _getMethod_ItemValue_V30(
    pd_Method_V30_t* m, uint8_t moduleIdx, uint8_t callIdx, uint8_t itemIdx,
